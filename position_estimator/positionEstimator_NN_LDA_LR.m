...
%    modelParameters(9).NNSpikesr = spikes_train;
%     modelParameters(9).NNLabels = direction_train;
%     modelParameters(9).NNValidationSpikes = ValidationData;
%     modelParameters(9).NNValidationPatience = 6;
%     modelParameters(9).NNLayerSizes = 100;

%   model_KNNspikesr = modelParameters(9).NNSpikesr;
%   model_KNNlabels = modelParameters(9).NNLabels;
...
%
  ...
  for m=1:N_trials_test
    ...
    dir = predict(modelParameters(9).nn, sr); % using toolbox
